					...
					<el-col :span="18" class="post-wrapper">
						<el-card class="post-content" v-loading="loading">
							...
							<div class="post-info">
								<div class="author"> 
									<div>
										<span class="head">文章作者：</span> <a href="/">ShenMuyan</a>
									</div>
								...
								<div style="height: 28px;"><span class="head">文章链接：</span> <a :href="`http://127.0.0.1:5173/article/detail/${article.id}`">http://127.0.0.1/article/detail/{{article.id}}</a> </div>
								<div style="height: 28px;"><span class="head">版权声明：</span> 本博客所有文章除特别声明外，转载请注明来自  <a href="/">Mr.Shen's blog</a>！</div>
							</div>
						</el-card>
					</el-col>
					<el-col :span="6">
