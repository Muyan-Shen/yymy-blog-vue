<template>
	<div class="user-wrapper">
		...
		<div style="margin-top: 20px; display: flex; justify-content: center; align-items: center;">
			<a href="https://github.com/Muyan-Shen">
				<el-image :src="githubIcon" style="height: 20px; width: 20px;"></el-image>
			</a>
      <div style="width: 20px;"></div>
      <a href="tencent://AddContact/?fromId=45&fromSubId=1&subcmd=all&uin=504142151&website=www.oicqzone.com">
        <el-image :src="qqIcon" style="height: 20px; width: 20px; "></el-image>
      </a>
			<div style="width: 20px;"></div>
...
const goGithub = () => {
	window.location.href = 'https://github.com/Muyan-Shen'
}
</script>
